...
from qiskit.transpiler.synthesis.aqc import make_cnot_network, AQC, CNOTUnitCircuit, DefaultCNOTUnitObjective
from qiskit.algorithms.optimizers import L_BFGS_B

def get_approximate_circuit(unitary:np.ndarray, **kwargs):
    num_qubits = int(round(np.log2(unitary.shape[0])))
    default_params = {"network_layout":"sequ", "connectivity_type":"full", "depth":50}
